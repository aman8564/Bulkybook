...
.form - check - input:checked [type= checkbox] {
    background - image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='rgba%28255, 255, 255, 0.75%29' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='m6 10 3 3 6-6'/%3e%3c/svg%3e");
}
...
.was - validated.form - select:valid: not([multiple]):not([size]), .was - validated.form - select:valid: not([multiple])[size="1"], .form - select.is -valid:not([multiple]):not([size]), .form - select.is -valid:not([multiple])[size="1"]
{
    ...
    background - image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23073642' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e"), url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%232aa198' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.was - validated.form - select:invalid: not([multiple]):not([size]), .was - validated.form - select:invalid: not([multiple])[size= "1"], .form - select.is -invalid:not([multiple]):not([size]), .form - select.is -invalid:not([multiple])[size= "1"] {
    padding - right: 4.125rem;
    background - image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23073642' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e"), url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23d33682'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23d33682' stroke='none'/%3e%3c/svg%3e");
    background - position: right 0.75rem center, center right 2.25rem;
    background - size: 16px 12px, calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);
}
...
.btn - secondary {
  ...
  --bs - btn - hover - color: #fff;
  --bs - btn - hover - bg: #6f7e80;
  --bs - btn - hover - border - color: #697678;
  --bs - btn - focus - shadow - rgb: 150, 164, 166;
    --bs - btn - active - color: #fff;
  --bs - btn - active - bg: #697678;
  --bs - btn - active - border - color: #626f71;
  --bs - btn - active - shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
    --bs - btn - disabled - color: #fff;
...
.dropdown - menu {
    ...
    --bs - dropdown - color: #839496;
  --bs - dropdown - bg: #073642;
  --bs - dropdown - border - color: var(--bs - border - color - translucent);
    --bs - dropdown - border - radius: 0.375rem;
    --bs - dropdown - border - width: 1px;
    --bs - dropdown - inner - border - radius: calc(0.375rem - 1px);
    --bs - dropdown - divider - bg: #002b36;
  ...
  --bs - dropdown - link - active - color: rgba(255, 255, 255, 0.75);
    --bs - dropdown - link - active - bg: #073642;
  --bs - dropdown - link - disabled - color: #adb5bd;
  --bs - dropdown - item - padding - x: 1rem;
    --bs - dropdown - item - padding - y: 0.25rem;
    --bs - dropdown - header - color: #839496;
...
.nav {
    ...
    --bs - nav - link - disabled - color: #839496;
  display: flex;
    flex - wrap: wrap;
    padding - left: 0;
    margin - bottom: 0;
...
.nav - tabs {
    ...
    --bs - nav - tabs - border - color: #073642;
  --bs - nav - tabs - border - radius: 0.375rem;
    --bs - nav - tabs - link - hover - border - color: #073642;
  --bs - nav - tabs - link - active - color: rgba(255, 255, 255, 0.75);
    --bs - nav - tabs - link - active - bg: #002b36;
  --bs - nav - tabs - link - active - border - color: #073642;
...
.nav - pills {
    ...
    --bs - nav - pills - link - active - color: rgba(255, 255, 255, 0.75);
    --bs - nav - pills - link - active - bg: #073642;
}
.nav - pills.nav - link {
background: none;
border: 0;
...
.card {
    ...
    --bs - card - border - color: rgba(0, 43, 54, 0.95);
    --bs - card - border - radius: 0.375rem;
    --bs - card - box - shadow: ;
    --bs - card - inner - border - radius: calc(0.375rem - 1px);
    --bs - card - cap - padding - y: 0.5rem;
    --bs - card - cap - padding - x: 1rem;
    --bs - card - cap - bg: rgba(7, 54, 66, 0.25);
    --bs - card - cap - color: ;
    --bs - card - height: ;
    --bs - card - color: ;
    --bs - card - bg: rgba(238, 232, 213, 0.125);
...
.accordion {
    --bs - accordion - color: #839496;
  --bs - accordion - bg: #002b36;
  --bs - accordion - transition: color 0.15s ease-in-out, background - color 0.15s ease-in-out, border - color 0.15s ease-in-out, box - shadow 0.15s ease-in-out, border - radius 0.15s ease;
    ...
    --bs - accordion - btn - color: #839496;
  --bs - accordion - btn - bg: var(--bs - accordion - bg);
    --bs - accordion - btn - icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23839496'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
    --bs - accordion - btn - icon - width: 1.25rem;
    --bs - accordion - btn - icon - transform: rotate(-180deg);
    --bs - accordion - btn - icon - transition: transform 0.2s ease-in-out;
    --bs - accordion - btn - active - icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23a37b00'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
    --bs - accordion - btn - focus - border - color: #839ba1;
  --bs - accordion - btn - focus - box - shadow: 0 0 0 0.25rem rgba(7, 54, 66, 0.25);
    --bs - accordion - body - padding - x: 1.25rem;
    --bs - accordion - body - padding - y: 1rem;
    --bs - accordion - active - color: #a37b00;
  --bs - accordion - active - bg: #e6ebec;
}
...
.breadcrumb {
    ...
    --bs - breadcrumb - bg: #073642;
  --bs - breadcrumb - border - radius: 0.25rem;
    --bs - breadcrumb - divider - color: #839496;
...
.pagination {
    ...
    --bs - pagination - border - color: #073642;
  --bs - pagination - border - radius: 0.375rem;
    --bs - pagination - hover - color: var(--bs - link - hover - color);
    --bs - pagination - hover - bg: #073642;
  --bs - pagination - hover - border - color: #073642;
  --bs - pagination - focus - color: var(--bs - link - hover - color);
    --bs - pagination - focus - bg: #eee8d5;
  --bs - pagination - focus - box - shadow: 0 0 0 0.25rem rgba(7, 54, 66, 0.25);
    --bs - pagination - active - color: rgba(255, 255, 255, 0.75);
    --bs - pagination - active - bg: #073642;
  --bs - pagination - active - border - color: #073642;
  --bs - pagination - disabled - color: #073642;
  --bs - pagination - disabled - bg: transparent;
    --bs - pagination - disabled - border - color: #073642;
  display: flex;
    padding - left: 0;
    list - style: none;
}
...
.alert - primary {
    --bs - alert - color: #6d5200;
  --bs - alert - bg: #f0e7cc;
  --bs - alert - border - color: #e9dcb3;
}
...
.alert - secondary {
    --bs - alert - color: #4f595a;
  --bs - alert - bg: #e6eaea;
  --bs - alert - border - color: #dadfe0;
}
...
.alert - info {
    --bs - alert - color: #17537e;
  --bs - alert - bg: #d4e8f6;
  --bs - alert - border - color: #bedcf2;
}
...
.alert - warning {
    --bs - alert - color: #7a2d0d;
  --bs - alert - bg: #f5dbd0;
  --bs - alert - border - color: #efc9b9;
}
...
.alert - danger {
    --bs - alert - color: #7f204e;
  --bs - alert - bg: #f6d7e6;
  --bs - alert - border - color: #f2c3da;
}
...
.alert - light {
    --bs - alert - color: #989488;
  --bs - alert - bg: #fffdf9;
  --bs - alert - border - color: #fefcf7;
}
...
.alert - dark {
    --bs - alert - color: #042028;
  --bs - alert - bg: #cdd7d9;
  --bs - alert - border - color: #b5c3c6;
}
...
.progress {
    ...
    --bs - progress - bg: #073642;
  --bs - progress - border - radius: 0.375rem;
    --bs - progress - box - shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075);
    --bs - progress - bar - color: #b58900;
...
.list - group {
  ...
  --bs - list - group - bg: transparent;
    --bs - list - group - border - color: #073642;
  --bs - list - group - border - width: 1px;
    --bs - list - group - border - radius: 0.375rem;
    --bs - list - group - item - padding - x: 1rem;
    --bs - list - group - item - padding - y: 0.5rem;
    --bs - list - group - action - color: #839496;
  --bs - list - group - action - hover - color: #fff;
  --bs - list - group - action - hover - bg: #073642;
  --bs - list - group - action - active - color: #839496;
  --bs - list - group - action - active - bg: #eee8d5;
  --bs - list - group - disabled - color: #839496;
  --bs - list - group - disabled - bg: transparent;
    --bs - list - group - active - color: #fff;
  --bs - list - group - active - bg: #073642;
  --bs - list - group - active - border - color: #073642;
  display: flex;
    flex - direction: column;
    padding - left: 0;
    margin - bottom: 0;
...
.toast {
  ...
  --bs - toast - border - width: 1px;
    ...
    --bs - toast - header - color: #839496;
  --bs - toast - header - bg: #003f50;
...
.modal {
  ...
  --bs - modal - border - width: 1px;
    ...
    --bs - modal - header - border - color: #002b36;
  --bs - modal - header - border - width: 1px;
    --bs - modal - title - line - height: 1.5;
    --bs - modal - footer - gap: 0.5rem;
    --bs - modal - footer - bg: ;
    --bs - modal - footer - border - color: #002b36;
...
.popover {
    ...
    --bs - popover - bg: #073642;
  --bs - popover - border - width: 1px;
    --bs - popover - border - color: #002b36;
  --bs - popover - border - radius: 0.5rem;
    ...
    --bs - popover - header - bg: #073642;
  --bs - popover - body - padding - x: 1rem;
    --bs - popover - body - padding - y: 1rem;
    --bs - popover - body - color: #839496;
...
.offcanvas, .offcanvas - xxl, .offcanvas - xl, .offcanvas - lg, .offcanvas - md, .offcanvas - sm {
    ...
    --bs - offcanvas - color: ;
    --bs - offcanvas - bg: #073642;
  --bs - offcanvas - border - width: 1px;
    --bs - offcanvas - border - color: #002b36;
...
.text - bg - primary {
color: #fff !important;
  background - color: RGBA(181, 137, 0, var(--bs - bg - opacity, 1))!important;
}

.text - bg - secondary {
color: #fff !important;
  background - color: RGBA(131, 148, 150, var(--bs - bg - opacity, 1))!important;
}

.text - bg - success {
color: #fff !important;
  background - color: RGBA(42, 161, 152, var(--bs - bg - opacity, 1))!important;
}

.text - bg - info {
color: #fff !important;
  background - color: RGBA(38, 139, 210, var(--bs - bg - opacity, 1))!important;
}

.text - bg - warning {
color: #fff !important;
  background - color: RGBA(203, 75, 22, var(--bs - bg - opacity, 1))!important;
}

.text - bg - danger {
color: #fff !important;
  background - color: RGBA(211, 54, 130, var(--bs - bg - opacity, 1))!important;
}

.text - bg - light {
color: #000 !important;
  background - color: RGBA(253, 246, 227, var(--bs - bg - opacity, 1))!important;
}

.text - bg - dark {
color: #fff !important;
  background - color: RGBA(7, 54, 66, var(--bs - bg - opacity, 1))!important;
}
